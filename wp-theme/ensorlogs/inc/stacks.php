...
function ensorlogs_stack_catalog(): array
{
    ...
    $catalog = array(
        ...
        'mac'        => array(
            'label' => 'Mac',
            'color' => '#a3a3a3',
            'icon'  => $svg('<path d="M16.6 13.2c0-2 1.7-2.9 1.8-3-1-1.4-2.5-1.6-3-1.6-1.3-.1-2.6.7-3.2.7-.6 0-1.7-.7-2.8-.7-1.5 0-2.8.9-3.6 2.2-1.5 2.7-.4 6.7 1.1 8.9.7 1.1 1.5 2.3 2.7 2.2 1.1 0 1.5-.7 2.8-.7s1.7.7 2.8.7c1.2 0 1.9-1.1 2.6-2.2.8-1.2 1.1-2.5 1.2-2.6-.1 0-2.4-.9-2.4-3.9zM13.6 6.9c.6-.7 1-1.7.9-2.7-.9 0-1.9.6-2.6 1.3-.5.6-1 1.6-.9 2.6 1 0 1.9-.5 2.6-1.2z"/>'),
        ),
    );
    return $catalog;
}
